...
jquery__WEBPACK_IMPORTED_MODULE_0___default()("#login").click(() => {
    console.log("button clicked");
    __webpack_require__.e(/*! import() */ 0).then(__webpack_require__.bind(null, /*! ./helpers */ "./src/helpers.js")).then(response => {
        ...
        addToDom('h1', result1, 'red');
        addToDom('h2', result2, 'green');


    });
});

jquery__WEBPACK_IMPORTED_MODULE_0___default()('#load-image').click(() => {
    console.log('load button');

    __webpack_require__.e(/*! import() */ 0).then(__webpack_require__.bind(null, /*! ./helpers */ "./src/helpers.js")).then(resp => {
        const { addImg } = resp;
        __webpack_require__.e(/*! import() */ 1).then(__webpack_require__.t.bind(null, /*! ./bunny.jpeg */ "./src/bunny.jpeg", 7)).then(src => {
            // console.log("src", src)
            addImg(src.default);
        })
